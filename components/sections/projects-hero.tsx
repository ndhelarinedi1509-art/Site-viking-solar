...
export function ProjectsHero({ section }: ProjectsHeroProps) {
  ...
  const badge = sectionString(section, 'badge', t('hero.projects.badge'));
  const title = section?.title || t('hero.projects.title');
  const titleHighlight = sectionString(section, 'titleHighlight', t('hero.projects.titleHighlight'));
  const description = section?.description || t('hero.projects.description');
