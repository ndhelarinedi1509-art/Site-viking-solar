        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-2xl border border-border-light bg-gradient-to-br from-[#0F1A2E] to-[#0A1628] p-8 sm:p-12 lg:p-14 text-center">
            ...
            <div className="relative z-10 mx-auto max-w-xl">
              <h2 className="text-3xl sm:text-4xl font-bold text-white">Prêt à passer à l&apos;énergie solaire ?</h2>
              <p className="mt-4 text-base text-gray-400">Contactez notre équipe aujourd&apos;hui pour un devis gratuit et personnalisé.</p>

              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12">
                <div className="text-center">
                  <span className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Téléphone</span>
