  ...
  return (
    <section className="py-12 sm:py-14 border-t border-border bg-bg-primary">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="relative overflow-hidden rounded-2xl border border-border-light bg-[linear-gradient(145deg,rgba(15,26,46,0.9),rgba(10,22,40,0.95))] p-8 sm:p-10 lg:p-12 text-center">
            {/* Green glow */}
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-6 py-2.5 text-sm font-semibold text-white transition-all duration-350 hover:bg-[#1fba5a] hover:shadow-[0_8px_24px_rgba(37,211,102,0.3)] active:scale-[0.98]"
                >
