...
INSERT INTO page_sections (page_key, section_key, section_type, label, title, subtitle, description, content, images, sort_order) VALUES
  ...
  ('home', 'cta', 'cta', 'CTA - Devis gratuit', 'Prêt à passer à l''énergie solaire ?', '', 'Obtenez un devis gratuit et personnalisé pour votre installation solaire à Kinshasa.', '{"buttons":[{"label":"Demander un devis","href":"/about#contact","variant":"primary"}]}', '[]', 40),
  ('about', 'hero', 'hero', 'Hero - À propos', 'Qui sommes-nous ?', 'Viking Solar', 'Viking Solar est une entreprise congolaise spécialisée dans les solutions d''énergie solaire.', '{"buttons":[{"label":"Nos services","href":"/services","variant":"primary"},{"label":"Contactez-nous","href":"/about#contact","variant":"outline"}]}', '[]', 0),
  ...
  ('services', 'hero', 'hero', 'Hero - Services', 'Nos services solaires', 'Solutions professionnelles', 'Des solutions complètes pour tous vos besoins en énergie solaire à Kinshasa et en RDC.', '{"buttons":[{"label":"Demander un devis","href":"/about#contact","variant":"primary"}]}', '[]', 0),
  ...
  ('projects', 'hero', 'hero', 'Hero - Projets', 'Nos réalisations', 'Projets solaires', 'Découvrez nos projets solaires réalisés à Kinshasa et à travers la RDC.', '{"buttons":[{"label":"Contactez-nous","href":"/about#contact","variant":"primary"}]}', '[]', 0),
