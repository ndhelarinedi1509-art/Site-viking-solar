...
export default function AdminProjectsPage() {
  ...
  const handleSave = (id: number) => {
    ...
    toast.success(`Projet "${project?.title}" sauvegardé`);
  };
          ...
          >
            ...
            <div className="p-4 space-y-3">
              <div className="space-y-1.5">
                <label className="block text-xs font-medium text-gray-400">Titre</label>
                <input
                  value={project.title}
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-medium text-gray-400">Catégorie</label>
                <input
